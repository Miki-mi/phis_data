...
//---------------------- Close Tab Validation  ----------------------
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
      if (request.action == "alert_user"){
        chrome.storage.local.get('state', data => {
            if (data.state === 'on'){
                var choice = confirm("!!! Warning !!!\nThe website you're visiting has been flagged as dangerous. To go back, click OK. To continue, click Cancel.");
                if (choice == true) //Close Tab
